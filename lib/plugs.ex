defmodule TwitterKittensWeb.Plugs.AssignCurrentUser do
  import Plug.Conn
...
defmodule TwitterKittensWeb.Plugs.RequireUser do
  import Plug.Conn
...
defmodule TwitterKittensWeb.Plugs.ConfigureTwitterClient do
  import Plug.Conn
  def init(opts) do; opts; end;
  def call(conn, _opts) do
